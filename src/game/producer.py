...
ALL_PRODUCERS = {
    ProducerType.ANT: Producer(
        ...
        rate=Product(resource=ResourceType.FOOD, rate=0.5),
    ...
    ProducerType.WORKER: Producer(
        ...
        rate=Product(resource=ResourceType.STICKS, rate=0.5),
    ...
    ProducerType.HAULER: Producer(
        ...
        rate=Product(resource=ResourceType.STONES, rate=0.5),
    ...
    ProducerType.SOLDIER: Producer(
        ...
        rate=Product(resource=ResourceType.LAND, rate=1.5),
    ...
    ProducerType.MINER: Producer(
        ...
        rate=Product(resource=ResourceType.METAL, rate=3),
    ...
    ProducerType.ENGINEER: Producer(
        ...
        rate=Product(resource=ResourceType.ENERGY, rate=3),
    ...
    ProducerType.LUMBERJACK: Producer(
        ...
        rate=Product(resource=ResourceType.LUMBER, rate=3),  # Rate will be auto-calculated on unlock
